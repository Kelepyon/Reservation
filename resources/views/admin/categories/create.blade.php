            ...
            <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data"
                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        <h2 class="text-base font-semibold leading-7 text-gray-900">Create Categories</h2>
                        <p class="mt-1 text-sm leading-6 text-gray-600">You can make categories on here.</p>
